...
const navItems = {
  ...
  records: [
    ...
    { href: "/admin/manage-pets", icon: PawPrint, label: "Manage Pets" },
              ...
              <div className="flex h-full flex-col">
                <div className="flex-1 overflow-y-auto p-4">
                  ...
                  <nav className="flex flex-col gap-4">
                    <div>
                        <h4 className="px-3 py-2 text-xs font-semibold uppercase text-muted-foreground/80 tracking-wider">Admin</h4>
                        <div className="flex flex-col gap-1">
                            {[...navItems.admin, ...navItems.records].map((item) => (
                    ...
                    <div>
                        <h4 className="px-3 py-2 text-xs font-semibold uppercase text-muted-foreground/80 tracking-wider">General</h4>
                        <div className="flex flex-col gap-1">
