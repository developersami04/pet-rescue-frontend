...
export const aboutUsStory = {
  title: 'Our Story',
  paragraphs: [
    'Petrescue was born from the passion and creativity of a dedicated team of interns as part of the Infosys SpringBoard program. Our goal was to apply our developing skills to a real-world challenge, and we chose to focus on a cause close to our hearts: animal welfare.',
    ...
    'At its core, the Petrescue project aims to empower young minds to turn ideas into impactful digital solutions while nurturing professional ethics, teamwork, and problem-solving skills. It’s more than just an internship — it’s a launchpad into the world of technology and innovation.'
  ],
};
